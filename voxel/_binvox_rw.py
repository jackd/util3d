...
See https://github.com/dimatura/binvox-rw-py.git for original version.
...
class Voxels(object):
    ...
    data is either a three-dimensional numpy boolean array (dense rep)
    or a two-dimensional numpy float array (coordinate rep).
